...
<section class="content_box cleafix">
	<div class="left_area fl">
		<form action="" method="">
			...
			<div class="form_body" data-view="phoneRegister">
				...
				<div style="display: block;" class="input_item" data-propertyname="phoneVerificationCode" data-controltype="PhoneVerificationCode">
				...
				<div style="display: block;" class="input_item clearfix" data-propertyname="password" data-controltype="Password">
					<input class="input input_white" id="" name="" placeholder="请输入密码" data-required="required" autocomplete="off" type="password">
				</div>
				...
				<div class="input_item clearfix" style="margin-top: 16px; display: block;" data-propertyname="protocol" data-controltype="CheckBox">
					<label class="box_checkbox" for="checkbox">
			            <span style="background-position: -13px 3px;" class="checkbox_icon"></span><input checked="checked" value="" id="checkbox" class="checkbox" data-myvalue="agred" data-text="我已阅读并同意" type="checkbox">我已阅读并同意
	...
	<div class="right_area fl">
		<h5>已有拉勾帐号:</h5>
		<a href="https://passport.lagou.com/login/login.html" class="login_now">直接登录</a>
		<h5>使用以下帐号直接登录:</h5>
