...
<script type="text/javascript" charset="utf-8" async="" src="{{URL::asset('files')}}/contains.js"></script><script type="text/javascript" charset="utf-8" async="" src="{{URL::asset('files')}}/taskMgr.js"></script>
<script type="text/javascript" charset="utf-8" async="" src="{{URL::asset('files')}}/views.js"></script>
<script type="text/javascript" src="{{URL::asset('files')}}/jquery.js"></script>
<!-- meta -->
...
<script type="text/javascript">
	function fun(){
		...
		//alert(name);
		if(name!=""){
			$.get("{{url('/Index/search_input')}}",{name:name},function(msg){
				$("#search_sp").html(msg);
				$("#search_sp").show();
			});
		}
