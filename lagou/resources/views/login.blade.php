...
<script src="{{URL::asset('/')}}/login/v.htm" charset="utf-8"></script><script src="{{URL::asset('/')}}/login/analytics.js" async=""></script><script src="{{URL::asset('/')}}/login/a.js" async=""></script><script type="text/javascript">
