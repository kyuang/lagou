<!DOCTYPE html>
<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script src="{{URL::asset('/')}}user_files/contains.js" async="" charset="utf-8" type="text/javascript"></script><script src="{{URL::asset('/')}}user_files/taskMgr.js" async="" charset="utf-8" type="text/javascript"></script><script src="{{URL::asset('/')}}user_files/views.js" async="" charset="utf-8" type="text/javascript"></script>
    <!-- meta -->
...
<script src="{{URL::asset('/')}}user_files/v.htm" charset="utf-8"></script><script src="{{URL::asset('/')}}user_files/analytics.js" async=""></script><script src="{{URL::asset('/')}}user_files/a.js" async=""></script><script type="text/javascript">
...
<div class="content user_modifyContent">
    <dl class="c_section">
        ...
        <dd>
                        <form action="{{url('Yonghu/geren_add')}}" method="post">
    	...
    	<p class="bding_title" style="margin-bottom:28px">验证你的手机号，完成手机帐号的绑定</p>
	   	 <div class="form_body clearfix" data-view="phonebinding" style="display: block;">
				...
				<div class="input_item clearfix" data-propertyname="request_form_verifyCode" data-controltype="VerifyCode" style="display:none;">
					...
					<img src="{{URL::asset('/')}}user_files/create.jpg" alt="" class="yzm">
...
<div class="footer_fix" id="footer">
    <div class="wrapper">
        ...
        <div class="inner_wrapper">
            <a class="footer_app" href="http://www.lagou.com/app/download.html" rel="nofollow">拉勾APP<span>new</span><img src="{{URL::asset('/')}}user_files/CgqLKVaLdtWAKVC3AAEEpK9-Koc598.JPG" height="256" width="256"></a>
            <a href="http://e.weibo.com/lagou720" target="_blank" rel="nofollow">拉勾微博</a>
            <a class="footer_qr" href="javascript:void(0)" rel="nofollow">拉勾微信<img src="{{URL::asset('/')}}user_files/CgpzWlZNl0qAZitPAABXEpAOJx0071.JPG" height="242" width="242"></a>
...
<script type="text/javascript" src="{{URL::asset('/')}}user_files/vendor_d53d12d.js"></script>
...
<script type="text/javascript" src="{{URL::asset('/')}}user_files/main.js"></script>
<script type="text/javascript" src="{{URL::asset('/')}}user_files/widgets_fd30dd4.js"></script><script src="{{URL::asset('/')}}user_files/h.js" type="text/javascript"></script>
<script type="text/javascript" src="{{URL::asset('/')}}user_files/userinfo_7f282e9.js"></script>
<script type="text/javascript" src="{{URL::asset('/')}}user_files/layout_a28dd79.js"></script>
<script type="text/javascript" src="{{URL::asset('/')}}user_files/main_002.js"></script>
