<!DOCTYPE html>
<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script src="<?php echo e(URL::asset('/')); ?>jianli_files/contains.js" async="" charset="utf-8" type="text/javascript"></script><script src="<?php echo e(URL::asset('/')); ?>jianli_files/taskMgr.js" async="" charset="utf-8" type="text/javascript"></script><script src="<?php echo e(URL::asset('/')); ?>jianli_files/views.js" async="" charset="utf-8" type="text/javascript"></script>
...
<script src="<?php echo e(URL::asset('/')); ?>jianli_files/v.htm" charset="utf-8"></script><script src="<?php echo e(URL::asset('/')); ?>jianli_files/analytics_002.js" async=""></script><script src="<?php echo e(URL::asset('/')); ?>jianli_files/a.js" async=""></script><script type="text/javascript">
...
var GLOBAL_DOMAIN = window.GLOBAL_DOMAIN || {
	...
	<!-- 主头部样式 -->
	<link href="<?php echo e(URL::asset('/')); ?>jianli_files/header.css" rel="stylesheet">

	<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/style_002.css">
	<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/style.css">
	<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/external.css">
	<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/popup.css">

	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery-1.js"></script>

	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery_003.js"></script>

	<!-- 主头部消息需要的滚动条样式 -->
	<link href="<?php echo e(URL::asset('/')); ?>jianli_files/mCustomScrollbar.css" rel="stylesheet">
	<!-- 主头部消息需要的滚动条 -->
	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery.js"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery_002.js"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/template-debug.js"></script>
	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/top-msg.js"></script>
	<!--C端头部消息 artemplate 模板-->
	<!-- 全部 -->
...
<!-- C-审核-Yes -->
	...
	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/ajaxfileupload.js"></script>

	<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/timeCountDown.js"></script>
	
	

		<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/additional-methods.js"></script>
...
<script defer="defer" id="_lgpassport_" data-css-site="0" data-css-popup="0" src="<?php echo e(URL::asset('/')); ?>jianli_files/passport.js" onload="passportInit()"></script>
...
<body><iframe style="position: absolute; width: 0px; height: 0px; border: 0px none;" tabindex="-1" title="" src="<?php echo e(URL::asset('/')); ?>jianli_files/id.htm" frameborder="0"></iframe><iframe style="display: none;"></iframe><style type="text/css">.WPA3-SELECT-PANEL { z-index:2147483647; width:463px; height:292px; margin:0; padding:0; border:1px solid #d4d4d4; background-color:#fff; border-radius:5px; box-shadow:0 0 15px #d4d4d4;}.WPA3-SELECT-PANEL * { position:static; z-index:auto; top:auto; left:auto; right:auto; bottom:auto; width:auto; height:auto; max-height:auto; max-width:auto; min-height:0; min-width:0; margin:0; padding:0; border:0; clear:none; clip:auto; background:transparent; color:#333; cursor:auto; direction:ltr; filter:; float:none; font:normal normal normal 12px "Helvetica Neue", Arial, sans-serif; line-height:16px; letter-spacing:normal; list-style:none; marks:none; overflow:visible; page:auto; quotes:none; -o-set-link-source:none; size:auto; text-align:left; text-decoration:none; text-indent:0; text-overflow:clip; text-shadow:none; text-transform:none; vertical-align:baseline; visibility:visible; white-space:normal; word-spacing:normal; word-wrap:normal; -webkit-box-shadow:none; -moz-box-shadow:none; -ms-box-shadow:none; -o-box-shadow:none; box-shadow:none; -webkit-border-radius:0; -moz-border-radius:0; -ms-border-radius:0; -o-border-radius:0; border-radius:0; -webkit-opacity:1; -moz-opacity:1; -ms-opacity:1; -o-opacity:1; opacity:1; -webkit-outline:0; -moz-outline:0; -ms-outline:0; -o-outline:0; outline:0; -webkit-text-size-adjust:none; font-family:Microsoft YaHei,Simsun;}.WPA3-SELECT-PANEL a { cursor:auto;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-TOP { height:25px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-CLOSE { float:right; display:block; width:47px; height:25px; background:url(http://combo.b.qq.com/crm/wpa/release/3.3/wpa/views/SelectPanel-sprites.png) no-repeat;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-CLOSE:hover { background-position:0 -25px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-MAIN { padding:23px 20px 45px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-GUIDE { margin-bottom:42px; font-family:"Microsoft Yahei"; font-size:16px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-SELECTS { width:246px; height:111px; margin:0 auto;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-CHAT { float:right; display:block; width:88px; height:111px; background:url(http://combo.b.qq.com/crm/wpa/release/3.3/wpa/views/SelectPanel-sprites.png) no-repeat 0 -80px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-CHAT:hover { background-position:-88px -80px;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-AIO-CHAT { float:left;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-QQ { display:block; width:76px; height:76px; margin:6px; background:url(http://combo.b.qq.com/crm/wpa/release/3.3/wpa/views/SelectPanel-sprites.png) no-repeat -50px 0;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-QQ-ANONY { background-position:-130px 0;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-LABEL { display:block; padding-top:10px; color:#00a2e6; text-align:center;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-BOTTOM { padding:0 20px; text-align:right;}.WPA3-SELECT-PANEL .WPA3-SELECT-PANEL-INSTALL { color:#8e8e8e;}</style><style type="text/css">.WPA3-CONFIRM { z-index:2147483647; width:285px; height:141px; margin:0; background:url(data:image/png;base64,) no-repeat;}.WPA3-CONFIRM { *background-image:url(http://combo.b.qq.com/crm/wpa/release/3.3/wpa/views/panel.png);}.WPA3-CONFIRM * { position:static; z-index:auto; top:auto; left:auto; right:auto; bottom:auto; width:auto; height:auto; max-height:auto; max-width:auto; min-height:0; min-width:0; margin:0; padding:0; border:0; clear:none; clip:auto; background:transparent; color:#333; cursor:auto; direction:ltr; filter:; float:none; font:normal normal normal 12px "Helvetica Neue", Arial, sans-serif; line-height:16px; letter-spacing:normal; list-style:none; marks:none; overflow:visible; page:auto; quotes:none; -o-set-link-source:none; size:auto; text-align:left; text-decoration:none; text-indent:0; text-overflow:clip; text-shadow:none; text-transform:none; vertical-align:baseline; visibility:visible; white-space:normal; word-spacing:normal; word-wrap:normal; -webkit-box-shadow:none; -moz-box-shadow:none; -ms-box-shadow:none; -o-box-shadow:none; box-shadow:none; -webkit-border-radius:0; -moz-border-radius:0; -ms-border-radius:0; -o-border-radius:0; border-radius:0; -webkit-opacity:1; -moz-opacity:1; -ms-opacity:1; -o-opacity:1; opacity:1; -webkit-outline:0; -moz-outline:0; -ms-outline:0; -o-outline:0; outline:0; -webkit-text-size-adjust:none;}.WPA3-CONFIRM * { font-family:Microsoft YaHei,Simsun;}.WPA3-CONFIRM .WPA3-CONFIRM-TITLE { height:40px; margin:0; padding:0; line-height:40px; color:#2b6089; font-weight:normal; font-size:14px; text-indent:80px;}.WPA3-CONFIRM .WPA3-CONFIRM-CONTENT { height:55px; margin:0; line-height:55px; color:#353535; font-size:14px; text-indent:29px;}.WPA3-CONFIRM .WPA3-CONFIRM-PANEL { height:30px; margin:0; padding-right:16px; text-align:right;}.WPA3-CONFIRM .WPA3-CONFIRM-BUTTON { position:relative; display:inline-block!important; display:inline; zoom:1; width:99px; height:30px; margin-left:10px; line-height:30px; color:#000; text-decoration:none; font-size:12px; text-align:center;}.WPA3-CONFIRM .WPA3-CONFIRM-BUTTON-FOCUS { width:78px;}.WPA3-CONFIRM .WPA3-CONFIRM-BUTTON .WPA3-CONFIRM-BUTTON-TEXT { line-height:30px; text-align:center; cursor:pointer;}.WPA3-CONFIRM-CLOSE { position:absolute; top:7px; right:7px; width:10px; height:10px; cursor:pointer;}</style>
	...
	<div id="body">
		...
		<div class="inner">
			<div class="lg_tnav_l">
				<a href="http://www.lagou.com/" class="lg_logo" data-lg-tj-id="5h00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull">
					<h1>拉勾网</h1>
				</a>
							</div>
			<ul class="lg_tnav_wrap reset">
				<li>
					<a href="http://www.lagou.com/" data-lg-tj-id="5i00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull">首页</a>
				</li>
				<li>
		...
		<!-- 数据展示类接口需要版本号 -->
	    <input id="version" value="1.5.6_2016051217" type="hidden">

	    <div id="container">
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/myresume.css">
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jianli_files/tailoring.css">
<input id="resumeId" value="4159727" type="hidden">
<input id="token" value="078be7c9d80a4cc5b3a03fa5089e445e" type="hidden">
<input id="isShowDefault" value="0" type="hidden">
	<div class="clearfixs mr_uncreate">
		<div class="mr_myresume_l">
			<div id="mr_mr_head">
				<div class="mr_top_bg">
					<img src="<?php echo e(URL::asset('/')); ?>jianli_files/default_headpic.png" alt="头像" class="mr_headimg" height="117" width="117">
					<img src="<?php echo e(URL::asset('/')); ?>jianli_files/tou.png" class="opa" alt="">
					<img src="<?php echo e(URL::asset('/')); ?>jianli_files/shadow_tx.png" alt="" class="shadow">
				...
				<div class="mr_baseinfo">
					...
					<div class="mr_my_qr">
						<div class="dropdown_menu">
							<!--广告位-->
							<div key="WODEJIANLI_ERWEIMA" class="lgad_jsonp"><img style="width: 302px; height: 155px;" src="<?php echo e(URL::asset('/')); ?>jianli_files/CgqLKVaLdduAeGaYAAEP1pBsVsU350.JPG"></div>
						</div>						
					</div>	
					
					<div class="mr_p_name mr_w604 clearfixs">
						<span class="mr_edit dn"><i></i><em>编辑</em></span><span class="mr_name">孟昭利</span>
					</div>
					<form id="nameForm">
					...
					<div class="mr_p_info mr_w604 clearfixs">		
						<div class="info_t">
							<span class="xl"><i></i><em>大专</em></span>
							<span class="gzjy"><i></i><em>2年工作经验</em></span>
							<span class="city"><i></i><em>北京</em></span>
						</div>
						<div class="info_b">
							<span class="mobile"><i></i><em>18310568509</em></span>
							<span class="email"><i></i><em title="18310568509@163.com">18310568509@163.com</em></span>
						</div>
						<span class="mr_edit mr_edit_unon dn" data-xl="大专" data-gzjy="2年" data-city="北京" data-mobile="18310568509" data-email="18310568509@163.com"><i></i><em>编辑</em></span>
					</div>	
					<form id="infoForm">
						<div class="mr_info_edit dn">
							
			   	 			<label>最高学历</label>
			   	 			<div class="form_wrap normal_s" style="*z-index:5;">
			   	 				<input id="xl" name="xl" class="mr_button" value="" type="button">
			   	 				<i class="mr_sj"></i>
								<div style="display: none;" class="xl_list dn">
				   	 				<ul class="ul_xl">
		                            				   	 					<li>大专</li>
				   	 								   	 					<li>本科</li>
				   	 								   	 					<li>硕士</li>
							...
							<label>电话</label>
			   	 			<div class="form_wrap">	
			   	 				...
			   	 				<input id="sess_phone" value="18310568509" type="hidden">
							...
							<label>邮箱</label>
			   	 			<div class="form_wrap">	
			   	 				...
			   	 				<input id="sess_email" value="" type="hidden">
			   	 				<i class="mr_locks"><em>在简历中保密，仅投递后对方才可查看<i></i></em></i>
			   	 			</div>	
			   	 			
			   	 			<label>所在城市</label>
			   	 			<div class="form_wrap city_s" style="*z-index:3;">
			   	 				<i class="mr_sj"></i>
			   	 				<input id="szcs" name="szcs" class="mr_button" value="" type="button">
								<div style="display: none;" class="xl_list dn">
								...
								<a href="javascript:;" class="mr_cancel" data-xl="大专" data-gzjy="2年" data-city="北京" data-mobile="18310568509" data-email="18310568509@163.com">取消</a>			   	 				
			   	 			</div>
						</div>
					</form>		
				</div>
			...
			<!--创建在线简历入口  -->
			<div class="mr_creattip clearfixs">
				<div class="mr_creatl fl">
					<h3>换工作是件需要深思熟虑的事</h3>
					<p>使用在线简历投递可以提高获得面试邀请的几率</p>
				</div>
				<div class="mr_creatr fr">
					<a href="<?php echo e(url('Yonghu/wanshan')); ?>" target="_self">
						<span>完善在线简历</span><i></i>
					</a>
				</div>
			</div>
		</div>
...
<div class="mr_uploaded clearfixs dn">
	<a href="javascript:;" class="mr_del"></a>
	<div class="mr_up_main">
		<a href="http://www.lagou.com/nearBy/downloadResume" title=""></a>
		<p></p>
	</div>
	<div class="mr_set_default dn">
		<div class="set_default_wrap">
  			<input id="default_resume" class="mr_button" value="默认投递：在线简历" type="button">
...
<div style="display:none;">
	...
	<div id="uploadFile" class="popup">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td align="center"><img src="<?php echo e(URL::asset('/')); ?>jianli_files/loading.gif" id="loadingImg" style="visibility: hidden;" alt="loading" height="16" width="55"></td>
	        </tr>
	    </tbody></table>
	</div><!--/#uploadFile-->
...
window.globals =  {
	resumeId: '4159727',
	token: '078be7c9d80a4cc5b3a03fa5089e445e',
	qrImgSrc:'http://www.lagou.com/qr/qrcode.jpg?qrSource=myResume'
};
</script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery_005.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/common.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/json.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery-migrate-1.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery-ui-1.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/jquery_004.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/components.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/new_myresume.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/ad-plat.js"></script>
<!------------------------------------- end ----------------------------------------->  
<!-- footer样式 -->
<link href="<?php echo e(URL::asset('/')); ?>jianli_files/main.css" rel="stylesheet">

			<div class="clear"></div>
	    	<div class="main_con_backup">
				<input id="resubmitToken" value="078be7c9d80a4cc5b3a03fa5089e445e" type="hidden">
...
<div id="feedback-con">
	...
	<input id="login-email" value="" type="hidden">
	<input id="login-phone" value="" type="hidden">
	<input id="login-realUserId" value="5117700" type="hidden">
</div>
...
<script>
	...
	global.idmd5 = "5117700";

</script>
<script src="<?php echo e(URL::asset('/')); ?>jianli_files/feedback.js"></script>
   			</div>
	    </div><!-- end #container -->
	</div><!-- end #body -->
	<div id="footer">
		<div class="wrapper">
			...
			<div class="inner_wrapper">
				<a class="footer_app" href="http://www.lagou.com/app/download.html" rel="nofollow">拉勾APP<span>hot</span><img src="<?php echo e(URL::asset('/')); ?>jianli_files/CgqLKVaLdtWAKVC3AAEEpK9-Koc598.JPG" height="256" width="256"></a>
	   			<a href="http://e.weibo.com/lagou720" target="_blank" rel="nofollow">拉勾微博</a>
		       	<a class="footer_qr" href="javascript:void(0)" rel="nofollow">拉勾微信<img src="<?php echo e(URL::asset('/')); ?>jianli_files/CgpzWlZNl0qAZitPAABXEpAOJx0071.JPG" height="242" width="242"></a>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/core.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/analytics.js"></script><script src="<?php echo e(URL::asset('/')); ?>jianli_files/h.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jianli_files/plat_tj.js"></script>
<script type="text/javascript">
    jQuery.ajax({
