...
<script src="<?php echo e(URL::asset('/')); ?>/login/v.htm" charset="utf-8"></script><script src="<?php echo e(URL::asset('/')); ?>/login/analytics.js" async=""></script><script src="<?php echo e(URL::asset('/')); ?>/login/a.js" async=""></script><script type="text/javascript">
		...
		<form action="javascript:;">
			<div class="form_body" data-view="loginView">
				<div style="display: block;" class="input_item clearfix" data-propertyname="username" data-controltype="Phone">
					<input class="input input_white" id="" name="" placeholder="请输入已验证手机/邮箱" data-required="required" autocomplete="off" type="text">
				</div>
				...
				<div class="input_item clearfix">
					<h5 class="reg_now">还没有拉勾帐号？<a href="https://passport.lagou.com/register/register.html">立即注册</a></h5>
				</div>
