<!DOCTYPE html>
<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/contains.js" async="" charset="utf-8" type="text/javascript"></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/taskMgr.js" async="" charset="utf-8" type="text/javascript"></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/views.js" async="" charset="utf-8" type="text/javascript"></script>
	<!-- meta -->
...
<script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/v.htm" charset="utf-8"></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/analytics.js" async=""></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/a.js" async=""></script><script type="text/javascript">
window.GLOBAL_DOMAIN = window.GLOBAL_DOMAIN || {
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jobdetails_files/mCustomScrollbar_ac2fb8b.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jobdetails_files/layout_8da9288.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jobdetails_files/main_002.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jobdetails_files/widgets_cd857e8.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('/')); ?>jobdetails_files/main.css">
<script charset="utf-8" class="lazyload" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/jquery.js"></script><style charset="utf-8" class="lazyload">@import  "http://pstatic.lagou.com/www/static/common/widgets/passport/css/loginpop_8eb0b34.css";</style><script async="" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/msgPopup_ccfc337.js" data-require-id="common/widgets/common/msgPopup"></script><script charset="utf-8" class="lazyload" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/lagou_5427c0e.js"></script><script async="" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/main_4b1b867.js" data-require-id="common/components/template-helper/main"></script><script id="_da" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/i.js" async="" charset="utf-8"></script></head>
<body><iframe style="position: absolute; width: 0px; height: 0px; border: 0px none;" tabindex="-1" title="" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/id.htm" frameborder="0"></iframe><iframe style="display: none;"></iframe>
...
-->
			...
			<ul class="lg_tbar_r">
				...
				<li class="msg_dropdown">
					...
					<div class="lg_msg_popup">
						<div style="overflow: hidden;" class="lg_msg_pu_body mCustomScrollbar _mCS_1" id="lgPopupMsgBody"><div class="mCustomScrollBox mCS-dark-2" id="mCSB_1" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 250px;"><div class="mCSB_container mCS_no_scrollbar" style="position:relative; top:0;">
        <ul class="lg_top_msg_list">
                ...
                <li class="lg_msg_item"><div>
                        ...
                        <!-- 系统消息，如果是纯文本消息，则无title，需要显示content -->
                                ...
                                <a class="detail" target="_blank" href="http://www.lagou.com/activity/dist/traffic/pc/index.html?utm_source=pt_yh_xxxt_bj_pc">CBD、望京、上地等五大互联网核心圈，高薪职位任你挑，真正“钱多离家近”！</a>
				...
				<li>
					<a href="<?php echo e(url('Yonghu/jianli')); ?>" class="bl" data-lg-tj-id="5700" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">我的简历</a>
				</li>
				<li>
				...
				<li class="user_dpdown">
					...
					<ul>
						...
						<li>
							<a href="<?php echo e(url('Index/loginout')); ?>" data-lg-tj-id="5e00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">退出</a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<!-- 全部 -->
<script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/adv-sim_8f68764.js"></script>
    ...
    <dd class="job_request">
        ...
        <p><font color="red">职位诱惑</font> : <?php echo e($entice); ?></p>
    ...
    <dd class="job_bt">
        ...
        <p>【您的职责】<br>1.
			...
			<?php endforeach; ?>
        <br>【我们的要求】<br>1.
			<?php foreach($ask as $va): ?>
				<?php echo e($va); ?><br>
			<?php endforeach; ?>
        </p>
<p>【我们的优势】&nbsp;</p>
<p>1.
	<?php foreach($gain as $val): ?>
				<?php echo e($val); ?><br>
	<?php endforeach; ?>
</p>
    </dd>
    ...
    <div class="jd-icon resume_status_bind fl">
        <div class="dropdown_menu">
            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/job_qr_btm.png" height="131" width="131">
        </div>
    </div>
...
<ul>
      ...
      <li>
          <a class="company-logo" href="http://www.lagou.com/jobs/1497796.html" target="_blank" data-index="0" data-lg-tj-id="9900" data-lg-tj-no="0000" data-lg-tj-cid="idnull">
              <img alt="公司Logo" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgYXBlTUV_eAFM_yAAAx8dJPvnI987.jpg">
          </a>
      ...
      <li>
          <a class="company-logo" href="http://www.lagou.com/jobs/1483100.html" target="_blank" data-index="1" data-lg-tj-id="9900" data-lg-tj-no="0001" data-lg-tj-cid="idnull">
              <img alt="公司Logo" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/Cgo8PFTUWHGAUTAcAABoeBHiSGQ931.jpg">
          </a>
      ...
      <li>
          <a class="company-logo" href="http://www.lagou.com/jobs/1218201.html" target="_blank" data-index="2" data-lg-tj-id="9900" data-lg-tj-no="0002" data-lg-tj-cid="idnull">
              <img alt="公司Logo" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/Cgp3O1YtmkSAZjX1AAA78knErXc273.jpg">
          </a>
      ...
      <li>
          <a class="company-logo" href="http://www.lagou.com/jobs/1018222.html" target="_blank" data-index="3" data-lg-tj-id="9900" data-lg-tj-no="0003" data-lg-tj-cid="idnull">
              <img alt="公司Logo" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgYXBlWvO6aAb5dRAAAVkbTWtmo562.gif">
          </a>
      ...
      <li>
          <a class="company-logo" href="http://www.lagou.com/jobs/1169242.html" target="_blank" data-index="4" data-lg-tj-id="9900" data-lg-tj-no="0004" data-lg-tj-cid="idnull">
              <img alt="公司Logo" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgqKkVZv9oyAebyDAACpLbec-1E022.jpg">
          </a>
    ...
    <dt>
        ...
        <img class="b2" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgYXBlWbsrmAIuU_AAA75o33yM8053.jpg" alt="北京易掌云峰科技有限公司" height="80" width="80">
        <div>
            <h2 class="fl">
                                    环信即时通讯云
                                                    <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/valid_f5bfb53.png" alt="拉勾认证企业" height="19" width="15">
        ...
        <div class="jobs_similar_detail" id="jobs_similar_detail">
            <ul class="similar_list reset">
                        ...
                        <div class="similar_list_item_logo">
                            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/Cgo8PFTUXX2AcRWdAADOPo-g3sU695.jpg" alt="成都彼索科技有限公司" height="56" width="56">
                        </div>
    ...
    <span>[北京·酒仙桥]</span>
                    ...
                    <div class="similar_company_info dn">
                        ...
                        <div class="similar_list_item_logo">
                            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgYXBlTUWAWAOBXrAABGHHFb0q8748.jpg" alt="百度" height="56" width="56">
                        </div>
                        <div class="similar_list_item_pos">
    ...
    <span>[北京·西北旺]</span>
                    ...
                    <div class="similar_company_info dn">
                        ...
                        <div class="similar_list_item_logo">
                            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/Cgp3O1ZdBzmAFpPQAAAKbLHSQYo055.jpg" alt="Rush" height="56" width="56">
                        </div>
                        <div class="similar_list_item_pos">
    ...
    <span>[北京·望京]</span>
                    ...
                    <div class="similar_company_info dn">
                        ...
                        <div class="similar_list_item_logo">
                            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgYXBlW8iEGAN2PbAACMbcr33-g643.JPG" alt="学科网" height="56" width="56">
                        </div>
                        <div class="similar_list_item_pos">
    ...
    <span>[北京]</span>
                    ...
                    <div class="similar_company_info dn">
                        ...
                        <div class="similar_list_item_logo">
                            <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/Cgp3O1bLx9qAWoD8AAAZw5f3tqI462.jpg" alt="视界核心" height="56" width="56">
                        </div>
                        <div class="similar_list_item_pos">
                            <h2 title="高级java开发工程师">高级java开发工程师</h2>
                            <p>30k-60k</p>
    ...
    <span>[北京·姚家园]</span>
			...
			<!--广告位-->
			<div key="ZHIWEIYE_YOUCEERWEIMA" class="lgad_jsonp" style="margin-top: 20px;"><img style="width: 282px; height: 130px;" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgqLKVZWrF2AOzoPAABEzeglC_w497.JPG"></div>
		</div>
	</div>
	<!-- 页面主体END -->
...
<div id="footer">
    <div class="wrapper">
        ...
        <div class="inner_wrapper">
            <a class="footer_app" href="http://www.lagou.com/app/download.html" rel="nofollow">拉勾APP<span>new</span><img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgqLKVaLdtWAKVC3AAEEpK9-Koc598.JPG" height="256" width="256"></a>
            <a href="http://e.weibo.com/lagou720" target="_blank" rel="nofollow">拉勾微博</a>
            <a class="footer_qr" href="javascript:void(0)" rel="nofollow">拉勾微信<img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgpzWlZNl0qAZitPAABXEpAOJx0071.JPG" height="242" width="242"></a>
...
-->
    ...
    <div id="uploadFile" class="popup popup_jd">
        <table width="100%">
            ...
            <tr>
                <td align="center">
                    <img src="<?php echo e(URL::asset('/')); ?>jobdetails_files/loading.gif" id="loadingImg" style="visibility: hidden;" alt="loading" height="16" width="55">
                </td>
            </tr>
        </tbody></table>
    </div>
    ...
    <div id="deliverResumesSuccess" class="popup popup_jd" style="width:500px;padding-bottom:10px;">
        ...
        <div class="jd_delivery_list clearfixs">
            <!--广告位-->
            <div key="JIANLITOUDIDANKUANG_JIANLITOUDIDANKUANG" class="lgad_jsonp" style="width: 430px; height: 156px; margin: 0 auto 35px auto;"><img style="width: 430px; height: 156px;" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/CgpzWlaLeTmAMzitAADRm6bjCE4506.JPG"></div>
        </div>
    </div>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/vendor_d53d12d.js"></script>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/main_002.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/widgets_4dd49c9.js"></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/h.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/userinfo_7f282e9.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/layout_a28dd79.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/main.js"></script>
...
<script type="text/javascript" src="<?php echo e(URL::asset('/')); ?>jobdetails_files/ipinyou_dd4456b.js"></script>


<script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/api"></script><script src="<?php echo e(URL::asset('/')); ?>jobdetails_files/getscript"></script></body></html>